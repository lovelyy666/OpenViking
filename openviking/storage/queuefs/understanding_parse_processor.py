...
class UnderstandingParseProcessor(DequeueHandlerBase):
    ...
    async def on_dequeue(self, data: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        ctx = RequestContext(
            ...
            saa_provider_context=ProviderRequestContext.from_dict(msg.saa_provider_context),
        )
            ...
            try:
                ...
                if retry_count < max_retries:
                    ...
                    retry_msg = UnderstandingParseMsg(
                        ...
                        saa_provider_context=msg.saa_provider_context,
                    )
        ...
        with (
            ...
            bind_provider_request_context(ctx.saa_provider_context),
        ):
            try:
