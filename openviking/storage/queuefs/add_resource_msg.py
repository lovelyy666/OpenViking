...
class AddResourceMsg:
    ...
    def __post_init__(self) -> None:
        if isinstance(self.saa_provider_context, ProviderRequestContext):
            self.saa_provider_context = self.saa_provider_context.to_dict()
        elif isinstance(self.saa_provider_context, dict):
            self.saa_provider_context = dict(self.saa_provider_context)
        else:
